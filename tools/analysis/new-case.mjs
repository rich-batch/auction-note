...
//   node tools/analysis/new-case.mjs seoul-central-2026ta12345 2026타경12345
import fs from 'node:fs';
import { casePath, casesDir, ID_RE, rel, todayKST } from '../lib/paths.mjs';

const [id, number] = process.argv.slice(2);
if (!id || !number) { console.error('사용법: new-case.mjs <id> <사건번호>  예: new-case.mjs seoul-central-2026ta12345 2026타경12345'); process.exit(2); }
...
const tpl = {
  ...
  case: { number, item_no: 1, court: '', kind: '임의경매', property_type: '', region: '', area_m2: null },
